...
class PurchaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $sales->inv_no = $inv;
        $sales->sup_bill_no = $request->bill_no;
        $cost_amount = array();
        $retail_amount = array();
        ...
        if($request->storage == 's'){
            $sales->pur_type =  'stock';
        }elseif($request->storage == 'b'){
            $sales->pur_type =  'backup';
        }
        ...
        if(array_product($e) == 1 and array_product($a) == 1 and array_product($backup) == 1){
            ...
            purchases::where('id',$sales->id)->delete();
