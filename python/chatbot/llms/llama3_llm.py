...
class Llama3LLM:
    ...
    def generate(self, prompt, max_tokens=1000, temperature=0.7, top_p=0.9, top_k=50, repeat_penalty=1.1):
        """
    ...
    def generate_stream(self, prompt, max_tokens=80, temperature=0.7, top_p=0.9, top_k=50, repeat_penalty=1.1):
            """
