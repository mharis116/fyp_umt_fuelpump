...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Suppliers Management</h6>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{route('supplier.edit',$p->id)}}">
                                                ...
                                                <form action="{{route('supplier.destroy',$p->id)}}" id="delete{{$p->id}}" method="post">
                                                    @csrf
                                                    @method('Delete')
                                                </form>
                                            @endif
