...
<div class="row">
    <div class="col-md-12">
        <form id="form" action="{{route('report.sale.dailysalefilter')}}" method="post">
            @csrf
            <div class="card p-4">
                <h6 class="card-title">
...
<div class="row">
    <script>
        ...
        var r = [];
        @foreach ($sale as $sr)
            d.push('{{date_format(date_create($sr->date),"Y-m-d")}}');
            q.push({{$sr->qty}});
            r.push({{$sr->rm + $sr->adj}});
        @endforeach
        $(function() {
    ...
    <div class="col-xl-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h6 class="card-title">Daily Sale</h6>
            ...
            <tbody>
                @foreach ($sale as $s)
                    <tr>
                        ...
                        <td> {{$s->qty}} ltrs </td>
                        <td>
                            <a href="{{route('report.sale.dailysaleitem',$s->date)}}">
