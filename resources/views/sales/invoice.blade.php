...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href='{{route('report.sale.dailysaleitem',$pur->sdate)}}' >Daily Sale Items</a></li>
    <li class="breadcrumb-item active" aria-current="page">Sale Item Invoice</li>
  </ol>
</nav>
@else
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{route('sale.create')}}">Sales</a></li>
      ...
      <div class="card-body">
        <div class="container-fluid d-flex justify-content-between">
          ...
          <div class="col-lg-3 pr-0">
            ...
            <h6 class="mb-0 mt-3 text-right font-weight-normal mb-2"><span class="text-muted">Invoice Date :</span> {{$pur->sdate}}</h6>
                ...
                <tbody>
                  ...
                  @foreach ($pii as $pi)
                     <tr class="text-right">
                      ...
                      <td>{{$pi->qty}} ltrs</td>
                      <td>{{$pi->retail_price}} Rs</td>
                      <td>{{$pi->subtotal}} Rs</td>
                    </tr>
                    @php
                      $i+=1;
                    @endphp
                ...
                <div class="table-responsive">
                  <table class="table">
                      <tbody>
                        <tr>
                          <td>Sub Total</td>
                          <td class="text-right">{{$pur->retail_amount}} Rs</td>
                        </tr>
                        ...
                        <tr class="bg-light">
                          ...
                          <td class="text-bold-800 text-right">{{$pur->retail_amount + $pur->adjustment}} Rs</td>
                        </tr>
                         <tr>
                          <td>Cash</td>
        ...
        <div class="container-fluid w-100">
          <button  data-toggle='tooltip' data-placement='top' title='Press Alt + P'  class="btn btn-outline-primary float-right mt-4 print-link no-print"><i data-feather="printer" class="mr-2 icon-md"></i>Print</button>
        </div>
      </div>
    </div>
  </div>
