...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item" aria-current="page">Customer Payment /</li>
    </ol>
</nav>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Customer Payments</h6>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{route('ctra.edit',$p->lid)}}">
                                                ...
                                                <form action="{{route('ctra.destroy',$p->lid)}}" id="del{{$p->lid}}" method="post">
                                                @csrf
                                                @method('Delete')
                                                </form>
                                            </div>
