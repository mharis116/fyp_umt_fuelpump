...
Route::get('losted', [App\Http\Controllers\DashboardController::class, 'losted'])->name('losted');
...
Route::middleware([
    ...
    Route::controller(ReportController::class)->group(function(){
        Route::get('report/credit','credit')->name('report.credit');
        ...
        Route::post('report/sale/profitfilter','profitfilter')->name('report.sale.profitfilter');
        Route::get('report/sale/profit','profit')->name('report.sale.profit');
        Route::get('report/expense','expense')->name('report.expense');
        Route::get('report/expense/item/{date}','expenseitem')->name('report.expense.item');
        Route::post('report/expensefilter','expensefilter')->name('report.expensefilter');
        Route::get('report/prices','price')->name('report.price');
        Route::post('report/prices/filter','pricefilter')->name('report.pricefilter');
    });
     Route::middleware(['other'])->group(function(){
